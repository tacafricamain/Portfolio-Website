...
const Data = () => {
    ...
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">My name is Jahswill</h3>
            <p className="home__description">I’m a Full-Stack developer based in Abuja, passionate about building seamless digital experiences from ideas to MVPs.</p>
